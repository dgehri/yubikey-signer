//! Domain types for Authenticode signed attributes.
//! Initial minimal types; will gain richer semantics.
...
impl SignedAttributesCanonical {
    ...
    pub fn new(mut attrs: Vec<SignedAttributeLogical>) -> Self {
        // Sort by DER bytes (lexicographic) per CMS DER rules for SET OF Attributes
